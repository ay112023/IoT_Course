Upd:
  ...
  тому замість нього підключив змвнний резистор на 22К, та загрузив проект туди із     підключенням до реального WiFi, а ESP32-A (Publisher) запустив у симуляторі. 
  Вийшло доволі прикольно. :)
  ESP32-B (Subscriber) реагував на натискання кнопки ESP32-A у симуляторі та 
...
Upd:
   ...
   що у ній розташувати бібліотечні файли,
