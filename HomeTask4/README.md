Upd:
  ...
  ESP32-A Опитує температуру, вологість та освітленність,
  ...
  ESP32-B Підписується на топіки
        ...
        (Якщо світлодіод вже світиться по перевищенню температурою уставки виходе 2 блимання,                 
        але вони сприймаються як 3 :) )
...
- ESP32-A використовує QoS 1 для публікації температури
