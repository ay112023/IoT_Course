...
Але heap у данному випадку використовується під внутрішні буфери бібіліотек, 
...
судячи із усього, глобально.При роботі програми FreeHeapSize за 5 хвилин роботи не зменшився:
